...
public class LimitLessTask extends TaskContent {
    ...
    static int tower=0,place=0,grade=0,coord_x=0,coord_y=0,rebuildCount=0;//挂机地点,坐标x,坐标y,复活次数
        ...
        new LimitLessTask(mFairy){
            ...
            public void create() throws Exception {
                ...
                if(!AtFairyConfig.getOption("place").equals("")){
                    ...
                    //选择等级
                    if(!AtFairyConfig.getOption("grade").equals("")){
                        grade=Integer.parseInt(AtFairyConfig.getOption("place"));
                    }
                }
            ...
            public void content_2() throws Exception {
                result=mFairy.findPic(492,382,782,546,new String[]{"xunlu.png"});
                result1=mFairy.findPic(492,382,782,546,new String[]{"chuansong.png"});
                ...
                if(place==0){
                    //和平模式
                    if(peace){
                        result=mFairy.findPic(1169,155,1252,257,"caidan.png");
                        if(result.sim<0.7){
                            mFairy.onTap(152,18,160,23,"展开",1000);
                            mFairy.onTap(161,52,171,59,"和平模式",1000);
                        }
                    }
                    setTaskName(4);
                    LtLog.e("不进入地图,直接挂机");
                ...
                //先判断一次当前地图对不对
                result = mFairy.findPic(1069,155,1271,253,new String[]{"menu.png","menu1.png"});
                mFairy.onTap(0.8f, result, 1186,72,1196,82, "打开地图", 3000);

                result = mFairy.findPic(785,57,933,186,"hcWorld.png");
                if (result.sim > 0.8f) {
                    Thread.sleep(2000);
                    mFairy.condit();
                    for (int i=0;i<=5;i++) {
                            switch (place) {
                                case 5:
                                    result1 = mFairy.findPic(337,136,488,335, "wordplace" + place + ".png");
                                    LtLog.e(mFairy.getLineInfo("龙泉村"));
                                    break;
                                case 6:
                                    result1 = mFairy.findPic(534,269,807,515, "wordplace" + place + ".png");
                                    LtLog.e(mFairy.getLineInfo("虎丘剑池"));
                                    break;
                                case 7:
                                    result1 = mFairy.findPic(334,217,514,402, "wordplace" + place + ".png");
                                    LtLog.e(mFairy.getLineInfo("明目谷"));
                                    break;
                                case 11:
                                    result1 = mFairy.findPic(307,254,646,523, "wordplace" + place + ".png");
                                    LtLog.e(mFairy.getLineInfo("紫阳书院"));
                                    break;
                                case 12:
                                    result1 = mFairy.findPic(424,299,538,442, "wordplace" + place + ".png");
                                    LtLog.e(mFairy.getLineInfo("雁鸣岭"));
                                    break;
                                case 13:
                                    result1 = mFairy.findPic(551,242,625,374, "wordplace" + place + ".png");
                                    LtLog.e(mFairy.getLineInfo("秋山盟"));
                                    break;
                                case 14:
                                    result1 = mFairy.findPic(288,156,411,358, "wordplace" + place + ".png");
                                    LtLog.e(mFairy.getLineInfo("青顶太池宫"));
                                    break;
                            }
                        if (result1.sim > 0.9f) {
                            setTaskName(3);
                ...
                //if(tower==0){
                    result = mFairy.findPic(785,57,933,186,"hcWorld.png");
                    mFairy.onTap(0.8f,result,"打开世界地图",2000);

                    //世界地图界 要去的挂机地
                    result1 = mFairy.findPic(665,323,930,478,"linan.png");
                    if(result1.sim > 0.8){
                        switch (place){
                            case 5:
                                result=mFairy.findPic(659,297,1272,680,"hcWorld_lqc.png");
                                mFairy.onTap(0.8f,result,"进入龙泉村",2000);
                                break;
                            case 6:
                                result=mFairy.findPic(659,297,1272,680,"hcWorld_hqjc.png");
                                mFairy.onTap(0.8f,result,"进入虎丘剑池",2000);
                                break;
                            case 7:
                                result=mFairy.findPic(659,297,1272,680,"hcWorld_mmg.png");
                                mFairy.onTap(0.8f,result,"进入明目谷",2000);
                                break;

                            case 11:
                                result=mFairy.findPic(313,312,659,693,"hcWorld_zysy.png");
                                mFairy.onTap(0.8f,result,"进入紫阳书院",2000);
                                break;

                            case 12:
                                result=mFairy.findPic(313,312,659,693,"hcWorld_yml.png");
                                mFairy.onTap(0.8f,result,"进入雁鸣岭",2000);
                                break;

                            case 13:
                                result=mFairy.findPic(313,312,659,693,"hcWorld_qsm.png");
                                mFairy.onTap(0.8f,result,"进入秋山盟",2000);
                                break;
                            case 14:
                                result=mFairy.findPic(313,312,659,693,"hcWorld_qdtsg.png");
                                mFairy.onTap(0.8f,result,"进入青顶太池宫",2000);
                                break;
                            case 8:
                        ...
                        if (result.sim > 0.8f){
                            //等级不够,无法入内,不前往地图
                            result=mFairy.findPic(446,367,941,494,"word can enter.png");
                            if(result.sim>0.8){
                                place=0;
                                setTaskName(0);
                                ...
                                LtLog.e(mFairy.getLineInfo("进入地图！"));
                                setTaskName(3);
                                return;
                            }
                        }
                        /*for (int i=0;i<=10;i++){
                            if (result.sim > 0.8f){
                                result1 = mFairy.findPic(785,57,933,186,"hcWorld.png");
                                if (result1.sim > 0.8f){
                                    LtLog.e(mFairy.getLineInfo("重复进入！ "));
                                    setTaskName(3);
                                    return;
                                }
                            }
            ...
            public void content_3() throws Exception{
                ...
                if(result1.sim > 0.8){
                    switch (grade){
                        case 10:
                            LtLog.e(mFairy.getLineInfo("10！"));
                            result=mFairy.findPic(293,100,791,533,"grade_10.png");
                            mFairy.onTap(0.8f,result,520,360,523,362,"10级刷怪点",2000);
                            break;
                        case 15:
                            LtLog.e(mFairy.getLineInfo("15！"));
                            result=mFairy.findPic(659,297,1272,680,"grade_15.png");
                            mFairy.onTap(0.8f,result,463,340,464,341,"15级刷怪点",2000);
                            break;
                        case 20:
                            LtLog.e(mFairy.getLineInfo("20！"));
                            result=mFairy.findPic(201,132,843,569,"grade_20.png");
                            mFairy.onTap(0.8f,result,result.x-22,result.y+52,result.x-21,result.y+53,"20级刷怪点",2000);
                            break;
                        case 25:
                            result=mFairy.findPic(201,132,843,569,"grade_25.png");
                            mFairy.onTap(0.8f,result,result.x+3,result.y+56,result.x+4,result.y+57,"25级刷怪点",2000);
                            break;
                        case 30:
                            result=mFairy.findPic(403,184,596,318,"grade_30.png");
                            mFairy.onTap(0.8f,result,result.x+4,result.y+75,result.x+5,result.y+76,"30级刷怪点",2000);
                            break;
                        case 35:
                            switch (place) {
                                case 13:
                                    result = mFairy.findPic(403, 184, 596, 318, "grade_35.png");
                                    mFairy.onTap(0.8f, result, result.x + 4, result.y + 32, result.x + 5, result.y + 33, "30级刷怪点", 2000);
                                    LtLog.e(mFairy.getLineInfo("秋山盟35级点位"));
                                    break;
                                case 14:
                                    result = mFairy.findPic(403, 184, 596, 318, "grade_45.png");
                                    mFairy.onTap(0.8f, result, result.x + 32, result.y + 51, result.x + 33, result.y + 52, "青顶太池宫45级点位", 2000);
                                    LtLog.e(mFairy.getLineInfo("青顶太池宫35级点位"));
                                    break;
                            }
                        case 45:
                            switch (place) {
                                case 13:
                                    result=mFairy.findPic(416,339,662,462,"grade_45.png");
                                    mFairy.onTap(0.8f,result,result.x+31,result.y+44,result.x+32,result.y+45,"秋山盟45级点位",2000);
                                    LtLog.e(mFairy.getLineInfo("秋山盟45级点位"));
                                    break;
                                case 14:
                                    result=mFairy.findPic(403,184,596,318,"grade_45.png");
                                    mFairy.onTap(0.8f,result,result.x+41,result.y+26,result.x+42,result.y+27,"青顶太池宫45级点位",2000);
                                    LtLog.e(mFairy.getLineInfo("青顶太池宫45级点位"));
                                    break;
                            }
                            result=mFairy.findPic("hang_yuntianjie.png");
                            mFairy.onTap(0.8f,result,"进入云天界",200);
            ...
            public void content_4() throws Exception {
                ...
                if (dazeTime > 10) {
                    LtLog.e("没有选择挂机地点!");
                    result=mFairy.findPic(1093,529,1274,625,"shezhi.png");
                    mFairy.onTap(0.8f,result,1202,189,1210,198,"关闭菜单",1000);

                    result=mFairy.findPic(1080,246,1257,333,"zdzd3.png");
                    if(result.sim > 0.8f) {
                    ...
                    result=mFairy.findPic(396,178,883,509,"syxlsc.png");
                    mFairy.onTap(0.8f,result,748,446,761,460,"剩余修炼确定",1000);
                    result=mFairy.findPic(727,562,945,634,"xljy.png");
                    mFairy.onTap(0.8f,result,824,597,842,606,"剩余修炼激活",1000);
                    mFairy.onTap(0.8f,result,1239,65,1247,79,"剩余修炼激活",1000);
                }
